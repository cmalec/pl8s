...
If you need to host your own configuration pages, please follow our [*Manual Setup*](https://developer.repebble.com/guides/user-interfaces/app-configuration/) guide.

![Clay sample configuration page](https://developer.repebble.com/assets/images/guides/user-interfaces/app-configuration/clay-sample.png)
...
Clay is available as a [*Pebble Package*](https://developer.repebble.com/guides/pebble-packages), so it
...
![Clay configuration page generated from the example settings](https://developer.repebble.com/assets/images/guides/user-interfaces/app-configuration/clay-actual.png)
...
Within our watchapp we need to open a connection with
[`AppMessage`](https://developer.repebble.com/docs/c/Foundation/AppMessage/) to begin
...
Once triggered, our handler will receive a
[`DictionaryIterator`](https://developer.repebble.com/docs/c/Foundation/Dictionary/#DictionaryIterator) containing
[`Tuple`](https://developer.repebble.com/docs/c/Foundation/Dictionary/#Tuple) objects for each `messageKey`. Note that the key names need to be
...
[Pebble Clay Example](https://github.com/pebble-examples/clay-example).
...
Why not find out more about [Clay for Pebble](https://github.com/pebble-dev/clay) and perhaps even [contribute](https://github.com/pebble-dev/clay/blob/master/CONTRIBUTING.md) to the
